...
(Get-Content "Cargo.toml") -replace "food_counter", $crate | Set-Content "Cargo.toml"
(Get-Content "src\main.rs") -replace "food_counter", $crate | Set-Content "src\main.rs"
(Get-Content "index.html") -replace "eframe template", $crate -replace "food_counter", $crate | Set-Content "index.html"
(Get-Content "assets\sw.js") -replace "food_counter", $crate | Set-Content "assets\sw.js"
